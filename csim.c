...
/*
 * parse_information: parse line information,
 * 		get access type, address and access size
 */
...
/*
 * parse_address: parse line address,
...
/*
 * access_cache: access the cache table,
 *      judge whether hits, misses or evictions
 */
...
/*
 * parse_line: parse line and call other functions
 */
...
/*
 * getTracesFile: get file and read the instruction
 */
...
/*
 * getCacheArgs: get args from termination
 */
...
/*
 * initCacheTable: initialize cache table
 */
void initCacheTable()
{
...
/*
 * init: initialize static various
 */
void init()
{
	hits = 0;
